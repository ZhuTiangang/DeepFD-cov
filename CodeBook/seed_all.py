...
if __name__ == '__main__':
    ...
    base_dir = (parent_dir + '/' + dataset + '/normal')
    ...
    for model in os.listdir(base_dir):
        ...
        # rely on the stats_faulty.csv under model directory
            ...
            stats_file_path = os.path.join(model_path, "stats.csv")
            ...
            fault_dict = content[content["Fault_dir"].astype('float32') == 1.].loc[:,
            ...
            # fault_dict={0:'opy',1:'lr',2:'act',3:'loss',4:'epoch'}
            # for debug only
            print("fault_dict", fault_dict)
